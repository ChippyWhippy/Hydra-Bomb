...
![Views](https://img.shields.io/badge/dynamic/json?url=https://gist.githubusercontent.com/ChippyWhippy/<VIEW_GIST_ID>/raw/views.json&label=Views&query=$.count&logo=github&color=green&cacheSeconds=1800&style=for-the-badge)
